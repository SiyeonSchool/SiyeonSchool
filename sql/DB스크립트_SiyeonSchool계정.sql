...
DROP SEQUENCE SEQ_FILENO; -- <ATTACHMENT> 테이블 PK시퀀스
DROP SEQUENCE SEQ_USERNO; --  <USERS> 테이블 PK시퀀스
DROP SEQUENCE SEQ_QUESTIONNO; -- <QUESTION> 테이블 PK시퀀스
DROP SEQUENCE SEQ_COMNO; -- <COMMENTS> 테이블 PK시퀀스
DROP SEQUENCE SEQ_COMREPLYNO; -- <COMMENT_REPLY> 테이블 PK시퀀스
DROP SEQUENCE SEQ_NOTINO; -- <NOTIFICATION> 테이블 PK시퀀스

-- 주의! <ATTACHMENT>, <QUESTION> 테이블이 <USERS>테이블 보다 위에서 선언되야함. 이렇게 안하면 에러남.
...
INSERT INTO COMMENTS VALUES(SEQ_COMNO.NEXTVAL, 3, '댓글 테스트 중입니다~~~', SYSDATE, DEFAULT);
INSERT INTO COMMENTS VALUES(SEQ_COMNO.NEXTVAL, 1, '잘 되려나~~~', SYSDATE, DEFAULT);
INSERT INTO COMMENTS VALUES(SEQ_COMNO.NEXTVAL, 2, '괜찮아 잘될거야', SYSDATE, DEFAULT);
INSERT INTO COMMENTS VALUES(SEQ_COMNO.NEXTVAL, 5, '오호~~ 아무말대잔치', SYSDATE, DEFAULT);
INSERT INTO COMMENTS VALUES(SEQ_COMNO.NEXTVAL, 4, '물결이 많다. 바다인가~~~', SYSDATE, DEFAULT);
INSERT INTO COMMENTS VALUES(SEQ_COMNO.NEXTVAL, 1, '답글을 테스트하려면 댓글이 더 필요해요', SYSDATE, DEFAULT);
INSERT INTO COMMENTS VALUES(SEQ_COMNO.NEXTVAL, 3, '그렇군요', SYSDATE, DEFAULT);
