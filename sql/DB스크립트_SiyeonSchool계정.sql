...
COMMENT ON COLUMN MAIL.SEND_CANCEL IS '발신취소여부';
...
COMMENT ON COLUMN SURVEY_POST.ON_GOING IS '진행여부';
COMMENT ON COLUMN SURVEY_POST.TEMP_SAVE IS '임시보관여부';
COMMENT ON COLUMN SURVEY_POST.STATUS IS '상태';
...
COMMENT ON COLUMN SURVEY_MEMBER.COMPLETE IS '완료여부';
