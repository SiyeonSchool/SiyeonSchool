...
INSERT INTO USERS VALUES(SEQ_USERNO.NEXTVAL, 'user32', 'pass32', '정국', '010-1234-5678', 'N', TO_DATE('1997-09-01', 'YYYY-MM-DD'), 'jungkook@bts.com', '서울시 강남구', TO_DATE('2024-05-09', 'YYYY-MM-DD'), TO_DATE('2024-05-09', 'YYYY-MM-DD'), 'A33', 2, '즐거운기억', 'U', 'W', NULL, NULL);
INSERT INTO USERS VALUES(SEQ_USERNO.NEXTVAL, 'user33', 'pass33', '지수', '010-2345-6789', 'N', TO_DATE('1995-01-03', 'YYYY-MM-DD'), 'jisoo@blackpink.com', '서울시 종로구', TO_DATE('2024-05-09', 'YYYY-MM-DD'), TO_DATE('2024-05-09', 'YYYY-MM-DD'), 'A34', 2, '사랑의기억', 'U', 'W', NULL, NULL);
INSERT INTO USERS VALUES(SEQ_USERNO.NEXTVAL, 'user34', 'pass34', '카이', '010-3456-7890', 'N', TO_DATE('1994-01-14', 'YYYY-MM-DD'), 'kai@exo.com', '서울시 강서구', TO_DATE('2024-05-09', 'YYYY-MM-DD'), TO_DATE('2024-05-09', 'YYYY-MM-DD'), 'A35', 2, '나의소원', 'U', 'W', NULL, NULL);
INSERT INTO USERS VALUES(SEQ_USERNO.NEXTVAL, 'user35', 'pass35', '아이린', '010-4567-8901', 'N', TO_DATE('1991-03-29', 'YYYY-MM-DD'), 'irene@redvelvet.com', '서울시 강북구', TO_DATE('2024-05-09', 'YYYY-MM-DD'), TO_DATE('2024-05-09', 'YYYY-MM-DD'), 'A36', 2, '편안한시간', 'U', 'W', NULL, NULL);
