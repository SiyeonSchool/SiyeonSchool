...
DECLARE
    long_text CLOB;
BEGIN
    long_text := '이 편지는 영국에서 최초로 시작되어 일년에 한바퀴를 돌면서 받는 사람에게 행운을 주었고 
    ...
    한국에서는 1970년대에 특히 퍼졌지만 생각보다 그 역사가 오래 됐다. 1931년 동아일보 기사[1]에서 "3, 4년 전 ''행운의 편지''라는 것이 성행하야 우편국 수입이 상당하였더니"라고 언급한 것으로 보아, 자그마치 1920년대 말부터 행운의 편지가 존재했음을 추리할 수 있다. # 우체국 의문의 호황
    ...
    INSERT INTO MAIL (
        ...
        'M0001', 
        28, 
        '행운의 편지 - 수신인이 많은 메일이고, 본문 내용이 긴 메일입니다. (테스트시 참고!)', 
        long_text, 
        'S', 
        SYSDATE
    );
...
INSERT INTO MAIL_RECEIVER VALUES('M508', 21, 'S', TO_DATE('2024-07-08 09:07:00', 'YYYY-MM-DD HH24:MI:SS'));
INSERT INTO MAIL_RECEIVER VALUES('M508', 22, 'C', NULL);
INSERT INTO MAIL_RECEIVER VALUES('M508', 23, 'C', NULL);
...
INSERT INTO MAIL_RECEIVER VALUES('M508', 28, 'R', NULL);
