        ...
        <div class="main-menu">
            ...
            <a href="<%= contextPath2 %>/home">
            	<% if(currentPage.equals("home")) { %>
 	  	            <!-- <img src="resources/images/home_sel.png" alt="홈버튼" style="height:45px; padding: 5px;"> -->
            ...
            <a href="<%= contextPath2 %>/mail">
            	<% if(currentPage.equals("mail")) { %>
	                <img src="resources/images/mail_sel.png" alt="메일버튼" style="height:48px; padding: 3px;">
            	<% } else { %>
            ...
            <a href="<%= contextPath2 %>/calendar">
                <% if(currentPage.equals("calendar")) { %>
	                <img src="resources/images/todo_sel.png" alt="일정버튼">
            	<% } else { %>
            ...
            <a href="<%= contextPath2 %>/contacts">
                <% if(currentPage.equals("contacts")) { %>
                	<img src="resources/images/add_sel.png" alt="주소록버튼">
            	<% } else { %>
            ...
            <a href="<%= contextPath2 %>/class">
                <% if(currentPage.equals("class")) { %>
	                <img src="resources/images/class_sel.png" alt="수업자료버튼" style="height:49px; padding: 3px;">
            	<% } else { %>
            ...
            <a href="<%= contextPath2 %>/homework">
                <% if(currentPage.equals("homework")) { %>
              	  <img src="resources/images/homework_sel.png" alt="과제버튼" style="height:47px; padding: 4px;">
            	<% } else { %>
            ...
            <a href="<%= contextPath2 %>/tool">
                <% if(currentPage.equals("tool")) { %>
	                <img src="resources/images/equipment_sel.png" alt="도구버튼">
            	<% } else { %>
